...
namespace TestProject
{
    public class Json_Test
    {
        ...
        public void Rotate_line_360_center()
        {
            Vector[] points = new Vector[2];
            points[0] = new Vector(0, 0);
            points[1] = new Vector(10, 5);
            Vector P = new Vector(10, 0);
            var line = new EllipseFactory().GetFigure(0, points[0], points[1]);
            var line2 = line.IsIn(P, 0.1);

            Assert.AreEqual(true, line2);
        }
